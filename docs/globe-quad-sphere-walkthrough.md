...
Thumbnails are static WebPs under `/examples/thumbnails/<slug>.webp`, generated by `scripts/capture-example-thumbnails.mjs`. See [`thumbnail-workflow.md`](./thumbnail-workflow.md) for the capture pipeline.
